...
RUN apt-get install -qqy libgearman-dev libtidy-dev supervisor gearman netcat imagemagick libfreetype6-dev libjpeg62-turbo-dev libpng-dev libmcrypt-dev libbz2-dev libxml2-dev libssl-dev libedit-dev libcurl4-openssl-dev
